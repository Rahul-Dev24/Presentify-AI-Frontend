...
const MY_PROJECTS = [
    {
        ...
        slides: 18,
        lastModified: "2m ago",
        previewColor: "bg-gradient-to-br from-blue-500/20 to-indigo-500/20",
    },
    {
        id: "2",
        ...
        previewColor: "bg-gradient-to-br from-purple-500/20 to-pink-500/20",
    },
    {
        id: "3",
        ...
        previewColor: "bg-gradient-to-br from-emerald-500/20 to-teal-500/20",
    }
];
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {MY_PROJECTS.map((project) => (
                    <Card key={project.id} className="group relative overflow-hidden border-none bg-white/50 dark:bg-slate-900/50 backdrop-blur-md transition-all hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-1">

                        {/* Thumbnail Preview Area */}
                        <div className={`relative aspect-[16/10] ${project.previewColor} flex items-center justify-center overflow-hidden`}>
                            {project.status === "completed" ? (
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-900/10 z-10">
                                    ...
                                    <p className="mt-3 text-[10px] font-bold uppercase tracking-widest text-blue-600 dark:text-blue-400">AI Designing...</p>
                                </div>
                            )}
                        ...
                        {/* Bottom Accent Line */}
                        <div className={`h-1 w-full bg-gradient-to-r ${project.status === 'processing' ? 'from-amber-400 to-orange-500' : 'from-blue-600 to-purple-600'}`} />
                    </Card>
                ))}
            </div>
        </div>
