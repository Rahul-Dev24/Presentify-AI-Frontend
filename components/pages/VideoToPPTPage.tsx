...
import {
    Video, Mic, Youtube, Link as LinkIcon,
    Upload, Sparkles, FileText, X, CheckCircle2,
    Settings
} from "lucide-react";
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-0">
                <div className=" w-full space-y-8">
                            ...
                            <Tabs defaultValue="video" onValueChange={setSourceType} className="w-full">
                                <div className="border-b dark:border-gray-700 bg-[#0f172a] p-4 pt-6 -mt-6">
                                    <TabsList className="grid w-full grid-cols-2 max-w-md mx-auto bg-gray-200/50 dark:bg-gray-800/50">
                                        <TabsTrigger value="video" className="gap-2"><Video size={16} /> Video</TabsTrigger>
                                        <TabsTrigger value="audio" className="gap-2"><Mic size={16} /> Audio</TabsTrigger>
                                    </TabsList>
                                </div>
                                ...
                                <div className="p-8 space-y-6">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                        ...
                                        <Button className="flex-[2] h-12 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:opacity-90 shadow-lg shadow-blue-500/25 gap-2 text-md font-bold">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-20">
                        {[
                            { icon: <CheckCircle2 className="text-green-500" />, title: "Auto Transcription", desc: "Perfectly transcribed text from any speaker." },
                            { icon: <FileText className="text-blue-500" />, title: "AI Summarization", desc: "Key points extracted and turned into slides." },
                            { icon: <Sparkles className="text-purple-500" />, title: "Designer Layouts", desc: "Beautifully designed slides based on content." }
                        ].map((f, i) => (
