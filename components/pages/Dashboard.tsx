    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <Card className="relative overflow-hidden border-none bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 text-white shadow-2xl">
            ...
            <Tabs defaultValue="chart" className="w-full">
                <div className="mb-6 w-full">
                    ...
                    <div className="w-full overflow-x-auto scrollbar-hide touch-pan-x overscroll-x-contain">
                        ...
                        {/* Pill wrapper */}
                        <div className="min-w-max inline-flex p-1.5 rounded-2xl 
      bg-gray-100/60 dark:bg-gray-800/40 backdrop-blur-md 
      border border-white/20 dark:border-gray-700/50">

                            <TabsList
                                className="flex flex-nowrap items-center gap-1 bg-transparent h-11"
                            >
                                <TabsTrigger
                                    value="chart"
