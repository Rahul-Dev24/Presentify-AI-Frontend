            ...
            <div className="container mx-auto px-6 py-4">
                <nav className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-6">
                        <Link href="#about">
                            <Button className="bg-gradient-to-r from-green-500 to-green-300 hover:from-green-600 hover:to-green-200">
                                About the project
                            </Button>
                        </Link>
                        {loading ? (
                            ...
                            <React.Fragment>
                                {isAuthenticated ? (
                                    ...
                                    <Link href="/login" className="text-zinc-400 hover:text-white transition-colors">
                                        <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-4 py-2 rounded-lg">
                                            Login
                                        </Button>
                                    </Link>
                                )}
