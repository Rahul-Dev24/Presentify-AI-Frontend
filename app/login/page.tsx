...
export default function LoginPage() {
    ...
    const handleLogin = async (e: any) => {
        ...
        try {
            ...
            const { data, res } = await getResponseData(await api.post(`/auth/${loginFlag ? "login" : "register"}`, resObj));
        ...
        <>
            <div className="flex items-center min-h-screen p-4 bg-zinc-950 text-white overflow-hidden relative lg:justify-center">
                ...
                <div className="flex flex-col overflow-hidden z-10 bg-white dark:bg-gray-900 rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
                    ...
                    <div className="p-4 py-6 text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
                    ...
                    <div className="p-5 bg-white dark:bg-gray-800 md:flex-1">
                        <h3 className="my-4 text-2xl font-semibold text-gray-700 dark:text-white"> {loginFlag ? 'Account Login' : 'Create Account'}</h3>
                        <form action="#" className="flex flex-col space-y-5">
                            ...
                            <div className="flex flex-col space-y-1">
                                <div className="flex items-center justify-between">
                                    ...
                                    {loginFlag && <a href="#" className="text-sm text-blue-600 dark:text-blue-400 hover:underline focus:text-blue-800">Forgot Password?</a>}
                                </div>
                                <input
                                    type="password"
                                    id="password"
                            ...
                            {!loginFlag && <div className="flex flex-col space-y-1">
                                <div className="flex items-center justify-between">
                            ...
                            <div className="flex flex-col space-y-5">
                                ...
                                <div className="flex flex-col space-y-4">
                                    ...
                                    {loginFlag ? (
                                        <a onClick={() => setLoginFlag(false)} className=" cursor-pointer flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-gray-800 dark:border-gray-600 rounded-md group hover:bg-gray-800 dark:hover:bg-gray-700 focus:outline-none">
                                        ...
                                        <a onClick={() => setLoginFlag(true)} className=" cursor-pointer flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-gray-800 dark:border-gray-600 rounded-md group hover:bg-gray-800 dark:hover:bg-gray-700 focus:outline-none">
                                            <span className="flex items-center justify-center">
                                                <svg
                                    ...
                                    {/* Go Back */}
                                    <Link href="/" className="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-blue-500 dark:border-blue-400 rounded-md group hover:bg-blue-500 focus:outline-none">
                                        <span className="flex items-center justify-center">
                                            <svg
