					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-xl text-zinc-400 mb-8 leading-relaxed">
								Based on advanced WebAV and FFmpeg technology, automatically identify key content in the video and generate a professional PPT. Supports local video, online links, and real-time screen recording.
							</p>
				...
				<div className="container mx-auto px-6">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-zinc-400 max-w-2xl mx-auto">
							Combining the latest WebAV and FFmpeg technologies to provide you with professional-level video processing capabilities.
						</p>
					</div>
						...
						{[
							{
								...
								description: "Select a local video file, enter an online video link, or start screen recording directly",
								icon: <Upload className="h-8 w-8" />,
							},
							{
								step: "02",
								title: "Intelligent Processing",
								description: "The AI system automatically analyzes the video content, recognizes key frames, and extracts important information and text",
								icon: <Zap className="h-8 w-8" />,
							},
							{
								step: "03",
								title: "Generate Download",
								description: "The system automatically generates a professional PPT file, supporting multiple formats for export and online preview",
					...
					<div className="text-center">
						<div className="rounded-2xl bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-zinc-700/50 p-12 backdrop-blur-sm">
							...
							<p className="text-xl text-zinc-400 mb-8 max-w-2xl mx-auto">
								Experience the powerful features of Video2PPT, which can convert your video content into a professional presentation document
							</p>
				...
				<div className="container mx-auto px-6">
					<div className="flex flex-col md:flex-row justify-between items-center">
						...
						<div className="flex items-center space-x-6">
							<div className="text-zinc-400 text-sm">© 2025 {ProjectInfo.name}. Built with WebAV and FFmpeg technologies</div>
